...
fake = 'Hinata'
yuz = '```'
owner = '919821992523' //ganti pake no lu
numbernye = '0'
...
const sekarang = new Date().getTime();
        ...
        const sendWebp = async(from, url) => {
            ...
            const sendKontak = (from, nomor, Name) => {
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + Name + '\n' + 'ORG:Kontak\n' + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
	        denz.sendMessage(from, { displayname: Name, vcard: vcard}, MessageType.contact)
            }
            const hideTagKontak = async function(from, nomor, Name){
	        ...
	        denz.sendMessage(from, { displayname: Name, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
            }
		const reply = (teks) => {
...
▢ ${yuz}${prefix}creategrup${yuz} 「 _Name|@tag_ 」
▢ ${yuz}${prefix}getppgc${yuz}
▢ ${yuz}${prefix}getdeskgc${yuz}
▢ ${yuz}${prefix}gcanime${yuz} 「 _Name gc_ 」
...
▢ ${yuz}${prefix}sticktag${yuz} 「 _Name sticker_ 」
...
//DARI SINI
                   case 'lazimedia':  
                   if (args.length < 1) return reply('MASUKKAN Name PRODUK')
                   ...
                   break           	                                                            
                    case 'artiName':  
                    if (args.length < 1) return reply('MASUKKAN Name')
                    F = body.slice(10)
                    anu = await fetchJson(`https://videfikri.com/api/primbon/artiName/?Name=${F}`)
                    anu1 = `➻ *ARTI* : ${anu.result.arti}\n`
...
denz.updatePresence(from, Presence.composing) 
		...
		break
				...
				case 'rate':
					...
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(9)
					zhain = await getBuffer(`https://onlydevcity.xyz/FFSerti/img.php?Name=${ct}`)
					...
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/FFSerti2/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'ffserti3':  			
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/FFSerti3/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'ffserti4':  				
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/FFSerti4/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'ffserti5':  			
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/FFSerti5/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break			
					case 'mlserti':  			
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(9)
					zhain = await getBuffer(`https://onlydevcity.xyz/MLTourSerti/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'mlserti2':  			
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/MLTourSerti2/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'mlserti3':  
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/MLTourSerti3/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'mlserti4':  			
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/MLTourSerti4/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'mlserti5':  
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(10)
					zhain = await getBuffer(`https://onlydevcity.xyz/MLTourSerti5/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'pubgserti':  
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(11)
					zhain = await getBuffer(`https://onlydevcity.xyz/PubgTourSerti/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'pubgserti2':  
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)
					ct = body.slice(12)
					zhain = await getBuffer(`https://onlydevcity.xyz/PubgTourSerti2/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'pubgserti3':  
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`)					 
					ct = body.slice(12)
					zhain = await getBuffer(`https://onlydevcity.xyz/PubgTourSerti3/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'pubgserti4':  
					if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
					reply(`WAIT KAK CANTIK/GANTENG`) 
					ct = body.slice(12)
					zhain = await getBuffer(`https://onlydevcity.xyz/PubgTourSerti4/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'pubgserti5':  								 				 
				    if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
				    reply(`WAIT KAK CANTIK/GANTENG`) 
					ct = body.slice(12)
					zhain = await getBuffer(`https://onlydevcity.xyz/PubgTourSerti5/img.php?Name=${ct}`)
					denz.sendMessage(from, zhain, image, {caption: 'NIH KACK', quoted: mek})
					break
					case 'tololserti':							 				 
				    if (args.length < 1) return reply(`[❗] CONTOH??\n${prefix}${command} whatsapp`)
				    F = body.slice(12)
				    reply(`WAIT KAK CANTIK/GANTENG`)
				    to = await getBuffer(`https://evilblackteam.nasiwebhost.com/serti1/img.php?Name=${F}`)
...
break
            ...
            break
				...
				if (!isGroup) return reply(mess.only.group)
					argzu = arg.split('|')
				if (!argzu) return reply(`Penggunaan ${prefix}kontak @tag|Name`)
				if (mek.message.extendedTextMessage != undefined){
                    mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
				...
				if (!isGroup) return reply(mess.only.group)
				argzi = arg.split('|')
				if (!argzi) return reply(`Penggunaan ${prefix}kontak @tag|Name`)
				if (mek.message.extendedTextMessage != undefined){
                    		mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
...
case 'ig':
            ...
            case 'facebook':
                ...
                .then((res) => {
					...
					const NamePack = exifff.split('|')[0]
					const authorPack = exifff.split('|')[1]
					exif.create(NamePack, authorPack)
...
case 'beliapi':        	
				...
				case 'sticker':
					...
					case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							wmsti = body.slice(11)
							if (!wmsti.includes('|')) return reply(`Kirim gambar atau reply gambar dengan caption *${prefix}stickerwm Name|author*`)
							const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
							const media = await denz.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
							...
							reply(`Kirim gambar/video dengan caption ${prefix}stickerwm Name|author atau tag gambar/video yang sudah dikirim\nNote : Durasi video maximal 10 detik`)
						}
						break
					case 'takestick':
					case 'take':
						if (!isQuotedSticker) return reply(`Reply sticker dengan caption *${prefix}takestick Name|author*`)
						const pembawm = body.slice(11)
						if (!pembawm.includes('|')) return await reply(`Reply sticker dengan caption *${prefix}takestick Name|author*`)
			...
			case 'ping':
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					nm = body.slice(12)
					if (!nm) return reply('Name sticker nya apa?')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					setik.push(`${nm}`)
				...
				case 'liststicker':
					...
					teks += `\n*Total : ${setik.length}*\n\n_Untuk mengambil sticker silahkan reply pesan ini dengan caption Name sticker_`
					...
					nm = body.slice(7)
					if (!nm) return reply('Name vn nya apa?')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					vien.push(`${nm}`)
				...
				case 'listvn':
					...
					teks += `\n*Total : ${vien.length}*\n\n_Untuk mengambil vn silahkan reply pesan ini dengan caption Name vn_`
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					nm = body.slice(10)
					if (!nm) return reply('Name image nya apa?')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					imagi.push(`${nm}`)
				...
				case 'listimage':
					...
					teks += `\n*Total : ${imagi.length}*\n\n_Untuk mengambil image silahkan reply pesan ini dengan caption Name image_`
			...
			case 'creategrup':
			if (!isGroup) return reply(mess.only.group)
				if (args.length < 1) return reply(`Penggunaan ${prefix}creategrup Name grup|@tag member`)
				argz = arg.split('|')
				if (mek.message.extendedTextMessage != undefined){
                    mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
                    for (let i = 0; i < mentioned.length; i++){
